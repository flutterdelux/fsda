...
mixin _$DiParam {
 ...
 String get name; bool get isNamed;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DiParam&&(identical(other.name, name) || other.name == name)&&(identical(other.isNamed, isNamed) || other.isNamed == isNamed));
}


@override
int get hashCode => Object.hash(runtimeType,name,isNamed);

@override
String toString() {
  return 'DiParam(name: $name, isNamed: $isNamed)';
}
...
/// Create a copy of DiParam
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? isNamed = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  bool isNamed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiParam() when $default != null:
return $default(_that.name,_that.isNamed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  bool isNamed)  $default,) {final _that = this;
switch (_that) {
case _DiParam():
return $default(_that.name,_that.isNamed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  bool isNamed)?  $default,) {final _that = this;
switch (_that) {
case _DiParam() when $default != null:
return $default(_that.name,_that.isNamed);case _:
  return null;
...
class _DiParam implements DiParam {
  const _DiParam({required this.name, required this.isNamed});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DiParam&&(identical(other.name, name) || other.name == name)&&(identical(other.isNamed, isNamed) || other.isNamed == isNamed));
}
...
/// Create a copy of DiParam
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? isNamed = null,}) {
