...
3. Select the packages you want to use under the "init -> packages:" key
   (Remove any infra adapters you don't want to use at this time)
4. Execute the initialization: fsda init
------------------------------------------------------------''';
}
